...
class slope_correction():
    ...
    def odom_callback(self, msg):
        ...
        corrected_x = float(utm_x + rotated[1])
        corrected_y = float(utm_y - rotated[0])
        corrected_z = float(utm_z - rotated[2])

        if self.first_flag == False:
            self.initial_x = corrected_x
            self.initial_y = corrected_y
            self.initial_z = corrected_z
        ...
        print "diff_x: ", self.initial_x - corrected_x
        print "diff_y: ", self.initial_y - corrected_y
        print
